				...
				<div id="page-content">
				  ...
				  <div id="rate-gold">
					  <div id="rate-gold_filter">
						<div class="field_title">Матеріал виробу <a href="/ua/faq#faq_question_220" target="_blank"><img src="/images/credit-calculator/help.png" width="16" height="16"></a></div>
						  <div class="filer-block_select">
							<select id="rate-gold-material" style="width: 200px; height: 35px;" name="">
							  <option selected="selected" value="default">-- Виберіть матеріал --</option>
						  ...
						  <div class="filer-block_select">
							<select id="rate-gold-category" style="width: 200px; height: 35px;" name="">
							  <option selected="selected" value="default">-- Виберіть тариф --</option>
						  ...
						  <div class="field_title">Маса</div>
						  <div class="filer-block_input" style="position: relative;">
							<div id="massa_value_hint">грам</div>
							<input value="" id="rate-gold-massa" type="number">
						  </div>

						  <div class="field_title">Строк кредитування</div>
						  <div class="filer-block_input" style="position: relative;">
							<div id="count_day_value_hint">днів</div>
					  ...
					  <div style="overflow: hidden; zoom: 1;">
						  <div id="evaluative-value" class="credit_calulator_result_1" style="display: block; float: left; width: 50%; white-space: nowrap;">
							<div style="line-height: 37px;">
							  <div style="font-size: 22px; color: #fff;">Cума на руки:</div>
						...
						<div id="evaluative-value" class="credit_calulator_result_2" style="display: block; float: left; white-space: nowrap;">
							<div style="line-height: 37px;">
							  <div style="font-size: 22px; color: #fff;">Cума викупу:</div>
							  <div>
								...
								<div id="discount_notifications" style="display: none; font-size: 14px;">(по акції «<a href="http://l-expert.com.ua/ru/akcii-lombard/265" target="_blank">Плати половину</a>»)</div>
							  </div>
							</div>
						</div>
						</div>
					...
					<?php /* ?>
					<div id="category_6__info" style="clear: both; padding: 0 27px 25px; display: none;">
						Тариф 6:<br>
						Ювелірний виріб повинен відповідати наступним критеріям:<br>
						— мати пробірне клеймо України,<br>
						— бути в гарному стані, цілим та не деформованим.<br>
					</div>
					<?php */ ?>
				  </div>
