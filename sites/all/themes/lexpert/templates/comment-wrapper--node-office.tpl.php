	...
	<?php if (!$comments) : ?>
		<section class="comments <?php print $classes; ?>"<?php print $attributes; ?>>
			<div class="comments-header no-comments">
				<h2 class="title"><?php print t('Відгуки'); ?></h2>
				<div class="comments-button">
					<input type="submit" class="submit" value="Залиште відгук" js-action="comments_guest_alert">
				</div>
			</div>

			<div style="text-align: center;"><?php print t('Немає відгуків.'); ?></div>
		</section>
	...
	<?php if (!$comments) : ?>
		<section class="comments <?php print $classes; ?>"<?php print $attributes; ?>>
			<div class="comments-header no-comments">
				<h2 class="title"><?php print t('Відгуки'); ?></h2>
				<div class="comments-button">
					<input type="submit" class="submit" value="Залиште відгук" js-action="comments_show_comment_form">
				</div>
			</div>
			...
			<?php if ($comment_form): ?>
				<div id="comments-comment-form">
						<h2 class="title comment-form" style="margin-top: 30px;"><?php print t('Додати відгук'); ?></h2>
