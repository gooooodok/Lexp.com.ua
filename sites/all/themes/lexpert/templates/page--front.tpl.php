	  ...
	  <tr>
		<td id="main-wrapper">
		  <div id="main-content">
			...
			<?php require_once('blocks/block-main-banner.php'); ?>

			<div id="adv-buttons__block">
				<?php print render($page['adv_buttons']); ?>
			</div>

			<?php if ($language->language == 'uk') : ?>
				<div class="beautiful-buttons-v2">
					<a class="button1" href="<?php print $base_path; ?>ua/kredit-pod-zalog/kreditniy-kalkulyator">
					...
					<a class="button2" href="<?php print $base_path; ?>ua/ocinka-zastavi/ociniti-tehniku">
						<div class="beautiful-title">
							<div class="beautiful-title_line">&nbsp;</div>
					...
					<a class="button3" href="https://online.lexp.com.ua">
						<div class="beautiful-title">
							<div class="beautiful-title_line">&nbsp;</div>
							Онлайн пролонгація
						</div>
						<img src="<?php print $base_path; ?>images/expert-online.png">
					</a>
				</div>
			...
			<!-- Content -->
			<div id="front-inner-content">
				<?php print $messages; ?>

				<div id="main-news">
					<?php print render($page['main_news']); ?>
				</div>
				...
				<?php // require_once('blocks/articles-previews.php'); ?>
