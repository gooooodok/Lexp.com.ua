 ...
 */
?>
<?php // СТРАНИЦА "ПРОКАЧАЙ СВОЮ ЗНИЖКУ" УКР ?>
<?php
		...
		<td id="main-wrapper">
		  <div id="main-content">
			...
			<div id="inner-content">
				...
				<p><img alt="" src="/files/files/images/banner_pr_ua.jpg" style="width:100%" /></p>
				...
				<form accept-charset="UTF-8" method="post" action="">
					...
					<div class="form-item">
						...
						<input id="email-id" name="email-id" type="email" maxlength="128" size="40" value="" placeholder="введіть email" autocomplete="off" style="width:97%!important" >
					</div>
					...
					<br><br>
					<p><a href="http://lexp.com.ua/ua/novosti/novosti-lombarda/prokachay-svoyu-znizhku">Умови акції</a></p>
					
				</form>


				  <?php //require_once('scripts/promo/promo_ua.php'); ?>
