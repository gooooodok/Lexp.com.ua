          ...
          <div id="main-content">
            ...
            <div id="inner-content">
            	<table class="beautiful-buttons" border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
					  <td>
					    <a href="<?php print $base_path; ?>ua/otdeleniya-lombarda">
					  ...
					  <td>
					    <a href="<?php print $base_path; ?>ua/vakansii-lombard">
					  ...
					  <td>
					    <?php /* <a href="<?php print $base_path; ?>ua/partnerstvo">
					    ...
					    <a href="<?php print $base_path; ?>ua/komisiyni-magazini">
                          <div class="beautiful-title" style="right: -25px !important; top: 25px;">
                            <div class="beautiful-title_line">&nbsp;</div>
                            Комісійні<br>магазини
                          </div>
					...
					<tr>
					  <td>
					    <a href="<?php print $base_path; ?>ua/novosti/novosti-lombarda">
					  ...
					  <td>
					    <a href="<?php print $base_path; ?>ua/kredit-pod-zalog">
					 ...
					 <td>
					    <a href="<?php print $base_path; ?>ua/finansova-zvitnist">
					      <div class="beautiful-title" style="right: 15px !important; top: 15px; width: 180px;">
					        <div class="beautiful-title_line">&nbsp;</div>
					        Фінансова звітність та інформація про відокремлені підрозділи
					      </div>
					    </a>
					  </td>
					</tr>
