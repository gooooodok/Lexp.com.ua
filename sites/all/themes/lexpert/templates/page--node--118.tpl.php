 ...
 */
?>
<?php // СТРАНИЦА "ОЦЕНКА ЗАЛОГА" УКР ?>
          ...
          <div id="main-content">
            ...
            <div id="inner-content">
                <table class="beautiful-buttons" border="0" cellpadding="0" cellspacing="0" width="100%">
                  <tr>
                    <td>
                      <a class="button3" href="<?php print $base_path; ?>ua/ocinka-zastavi/ociniti-zoloto">
                        <div class="beautiful-title">
                          <div class="beautiful-title_line">&nbsp;</div>
                          Онлайн-оцінка золота
                        </div>
                        <img src="<?php print $base_path; ?>images/button-gold.png" style="left: 135px !important; top: 13px !important;">
                      </a>
                    </td>
                    <td>
